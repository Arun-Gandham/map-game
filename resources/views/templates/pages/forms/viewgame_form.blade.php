        ...
        <div class="col">
            <div class="card mb-4">
                <form method="POST" class="mb-5"
                    action="{{ isset($viewgame) ? route('viewgame.edit.submit') : route('viewgame.add.submit') }}"
                    ...
                    <div class="row mb-3 p-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" placeholder="Name" name="name"
                                        value="{{ isset($viewgame) ? $viewgame->name : '' }}" required>
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="col-sm-11">
                                    <input type="number" class="form-control" placeholder="Max Time (in seconds)"
                                        name="max_time" value="{{ isset($viewgame) ? $viewgame->max_time : '' }}" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <textarea class="form-control" rows="8" name="description" required>{{ isset($game) ? $viewgame->description : '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 col-md-12 ">
                            <div class="d-flex justify-content-end">
                                <div class="">
                                    <input type="hidden" name="id" value="{{ isset($viewgame) ? $game->id : '' }}">
                                    <button type="submit"
                                        class="btn btn-primary me-sm-2 me-1 waves-effect waves-light">{{ isset($viewgame) ? 'Update' : 'Submit' }}</button>
                                    <button class="btn btn-label-secondary waves-effect"><a
                                            href="{{ route('viewgame.list') }}">Cancel</a></button>
                                </div>
                            </div>
                        </div>
                </form>
